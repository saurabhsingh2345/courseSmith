...
const openAPISpec = `{
  ...
  "components": {
    ...
    "schemas": {
      ...
      "LedgerRow": {
        "type": "object",
        "properties": {"day": {"type": "string"}, "provider": {"type": "string"}, "model": {"type": "string"}, "calls": {"type": "integer"}, "prompt_tokens": {"type": "integer"}, "completion_tokens": {"type": "integer"}, "cost_usd": {"type": "number"}},
        "required": ["day", "provider", "model", "calls", "prompt_tokens", "completion_tokens", "cost_usd"]
      },
      "QuotaStatus": {
        "type": "object",
