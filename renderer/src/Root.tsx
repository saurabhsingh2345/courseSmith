 ...
 *
 * The path data is real, extracted the way snippet_cards_art.go extracts it:
 * geometry only, colour stripped, painted here in the card's own accent.
 */
  ...
  scenes: [
    {
      ...
      props: {
        ...
        items: [
          {
            title: 'Claude',
            note: 'Holds a long argument about a codebase without losing the thread',
            role: 'quantity',
            icon: 'brain',
          ...
          {
            title: 'Gemini',
            note: 'Reads a whole repository at once and answers across all of it',
            role: 'rival',
            icon: 'sparkles',
          ...
          {
            title: 'ChatGPT',
            note: 'Fastest to a working answer, and the one everybody already has open',
            role: 'neutral',
            icon: 'message',
          },
        ],
