...
/** Keeps the app and the composer, drops the menu bar and the model row. */
export const DEFAULT_WIN: Rect = {x: 0, y: 150, w: 3456, h: 1944};
  ...
  return (
    <AbsoluteFill style={{backgroundColor: C.ink0}}>
      ...
      >
        ...
        >
          <OffthreadVideo
            src={staticFile('tutorial/source.mp4')}
